...
Utilizo el conjunto de datos `diabetes`. Lo divido en entrenamiento y validación.
...
Creo un modelo de regresión y ajusto a los datos de entrenamiento.

```{python}
regressor = LinearRegression().fit(X_train, y_train)
```

Evalúo el modelo a partir de las **métricas de desempeño**.
...
Creo un modelo lineal y una *receta*.
...
Genero estimaciones a partir de los datos de validación y el modelo generado.
...
Comparo las estimaciones con los valores reales.
